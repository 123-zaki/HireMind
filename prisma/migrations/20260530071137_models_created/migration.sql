...
-- CreateEnum
CREATE TYPE "AvailabiltyStatus" AS ENUM ('AVAILABLE', 'BOOKED', 'BLOCKED');
...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PROCESSING', 'PROCESSED');
...
CREATE TABLE "Availability" (
    ...
    "status" "AvailabiltyStatus" NOT NULL DEFAULT 'AVAILABLE',
