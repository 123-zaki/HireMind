...
const CATEGORY_PROMPTS = {
    ...
    BACKEND: "Node.js, databases, REST APIs, authentication, caching, scalability",
    FULLSTACK: "full-stack architecture, API design, state management, deployment",
    DSA: "data structures, algorithms, time and space complexity, problem-solving",
    SYSTEM_DESIGN: "distributed systems, microservices, scalability, databases, caching",
