            ...
            <CardContent className={`flex flex-col gap-5`}>
                <div className='flex items-start justify-between gap-3'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            <p className='text-sm font-medium text-stone-200 leading-tight'>{name}</p>
                            {title && company && (
                    ...
                    {/* Years of Experience */}
                    {yearsExp && (
                        <Badge variant='outline' className={`shrink-0 border-white/10 text-stone-500 text-xs`}>{yearsExp}+ yrs</Badge>
                    )}
                ...
                {/* Bio */}
                {bio && (
                    <p className='text-xs text-stone-400 font-light leading-relaxed line-clamp-2'>{bio}</p>
                )}
                ...
                {categories?.length > 0 && (
                    <div className='flex flex-wrap gap-1.5'>
                        {categories.slice(0, 4).map((cat) => (
                            <span key={cat} className='text-xs px-2.5 py-1 rounded-lg border border-amber-400/20 bg-amber-400/5 text-amber-400'>
