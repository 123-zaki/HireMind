...
function OnboardingPage() {
    ...
    const isInterviewerValid = form.title && form.company && form.yearsExp && form.bio && form.categories.length > 0;
    ...
    return (
        <div className='min-h-screen px-6 pb-24 flex flex-col items-center'>
            <div className='w-full max-w-2xl'>
                <div className='text-center mb-10'>
                    ...
                    <h1 className='font-serif text-5xl leading-tight tracking-tighter mt-1'>
                        ...
                        <br />
                        <GoldTitle>using Skiller?</GoldTitle>
                    </h1>
                    <p className='text-sm text-stone-500 font-light mt-4 leading-relaxed'>
                        This helps us prsonalize your experience.
                    ...
                    <div className='grid grid-cols-2 gap-4 w-full'>
                        {ONBOARDING_ROLES.map((r) => {
                            return <button
                                ...
                                className='rounded-2xl text-left p-8 border border-white/10 bg-[#0f0f11] hover:border-amber-400/20 hover:-translate-y-0.5 transition-all duration-300'
                            >
                                <span className='h-11 w-11 rounded-xl bg-amber-400/10 border border-amber-400/20 flex items-center justify-center text-xl mb-5'>
                                    {r.icon}
                                </span>
                ...
                {role && (
                    <div className='flex flex-col gap-6'>
                        ...
                        <Button variant="gold"
                            ...
                            {
                                loading ? "Setting up your account..." : role === "INTERVIEWER" ? "Create interviewer profile ->" : "Explore interviewers ->"
                            }
                        </Button>
                    </div>
                )}
