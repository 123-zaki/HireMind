    ...
    return (
        <main className="min-h-screen bg-black">
            ...
            <div className='max-w-6xl mx-auto px-8 py-12 grid grid-cols-1 lg:grid-cols-5 gap-10'>
                {/* Left */}
                <div className='lg:col-span-3 flex flex-col gap-6 order-1 lg:order-none'>
                    {/* Bio */}
                    {interviewer.bio && (
                    ...
                    {interviewer.categories?.length > 0 && (
                        <div className='bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-5'>
                            <div>
                                ...
                                <p className='text-sm text-stone-500 font-light mt-1'>Interview categories this expert covers</p>
                            </div>

                            <div className='flex flex-wrap gap-2.5'>
                                {interviewer.categories.map((cat) => (
                                    <span key={cat} className='text-sm px-4 py-2 rounded-xl border border-amber-400/20 bg-amber-400/5 text-amber-400'>
                    ...
                    <div className='bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-6'>
                        <div>
                            ...
                            <p>
                                Every session on skiller includes the following.
                            </p>
                        </div>
